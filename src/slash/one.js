        ...
        try {
            ...
            if (options.getBoolean('edit') === true) {
                ...
                await client.con
                    .promise()
                    .query(
                        `update one set building_size = ?, quality = ?, incompletion = ?, edit = true where msg_id = ${submissionId}`,
                        [basePoints, quality, incompletion]
                    )
                ...
                await client.con
                    ...
                    .query(
                        ...
                        [submissionId, basePoints, quality, incompletion]
                    )
